...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      cleanupOutdatedCaches: false, // Nueva linea para actualizar la aplicacion
      ...
      manifest: {
        name: "Aplicacion perrona PWA",
        short_name: "PWA-App",
        description: "Aplicacion bien perrona usando Vite, React y PWA",
        theme_color: "#ffffff",
        display_override: [
          "fullscreen",
          "minimal-ui",
